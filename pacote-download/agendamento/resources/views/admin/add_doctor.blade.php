                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{url('upload_doctor')}}" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <input required style="color: white;" type="text" class="form-control" id="exampleInputName1" placeholder="Nome" name="name">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail3">Telefone<span style="color: red;">*</span></label>
                        <input required style="color: white;" type="number" class="form-control" id="exampleInputEmail3" placeholder="Telefone" name="phone">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputPassword4">Sala<span style="color: red;">*</span></label>
                        <input required style="color: white;" type="number" class="form-control" id="exampleInputPassword4" placeholder="Sala" name="room">
                      </div>
                      
                      <div class="form-group">
                        <label for="exampleSelectGender">Especialidade<span style="color: red;">*</span></label>
                        <select required style="color: white;" class="form-control" id="exampleSelectGender" name="speciality">
                          <option value="">Selecionar uma</option>
                      ...
                      <div class="form-group">
                        <label>Selecionar imagem<span style="color: red;">*</span></label>
